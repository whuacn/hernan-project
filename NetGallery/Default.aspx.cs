    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (NetFile file in files)
        {
            if (file.Type == TypeFile.Folder)
                thegallery.InnerHtml += "<li><center><img src='/Images/galeria.png' style='width:100px' onclick='location.href=\"/?p=" + file.Path + "\"'  /><div style='position:absolute; text-align:center; width:200px'>" + file.Name + "</div><center></li>";
