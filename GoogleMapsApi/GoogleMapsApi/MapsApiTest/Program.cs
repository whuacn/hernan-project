...
namespace MapsApiTest
{
	class Program
	{
 		...
 		static void Main(string[] args)
		{
			...
			{
                Address = "mitre 751, C1036AAM, Capital Federal, Argentina",
                Language = "es",          
                Region = "ar",
            ...
            foreach (Result result in geocode.Results)
            {
                ...
                foreach (AddressComponent AC in result.AddressComponents)
                {
                    Console.WriteLine("LongName:" + AC.LongName);
                }
                Console.WriteLine("Location:" + result.Geometry.Location.LocationString);
