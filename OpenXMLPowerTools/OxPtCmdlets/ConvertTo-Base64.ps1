...
function ConvertTo-Base64 {
    ...
    {
        ConvertToJavaScriptLiteral $FileName $WithCode
    }
    elseif ($PowerShellLiteral)
    {
        ConvertToPowerShellLiteral $FileName $WithCode
    }
    elseif ($CSharpLiteral)
    {
        ConvertToCSharpLiteral $FileName $WithCode
    }
    elseif ($VBLiteral)
    {
        ConvertToVBLiteral $FileName $WithCode
    }
    else
    {
        $fname = (Resolve-Path $FileName).ToString();
        [OpenXmlPowerTools.Base64]::ConvertToBase64($FileName)
    }
}
...
"@
'"@'
'ConvertFrom-Base64 "Test.docx" $b64'
    }
    else
    {
'@"'
